...
- **Production Agent Flow**：Rust 后端 Agent 按 Plan → Memory → Plotter → Character → Dialogist → AssetPlanner → SceneScript 执行，当前完成 P1 内容链路；详见 [`../v2-agent-pipeline.md`](../v2-agent-pipeline.md)。
